...
Status: **shipped on `main`** via [#133](https://github.com/uniskela/ts6-manager/pull/133), [#136](https://github.com/uniskela/ts6-manager/pull/136), [#138](https://github.com/uniskela/ts6-manager/pull/138), [#140](https://github.com/uniskela/ts6-manager/pull/140). Optional leave-metadata enrichment [#74](https://github.com/uniskela/ts6-manager/issues/74) remains open and is **not** required for journal ship. Acceptance roll-up: [`91-slice-6-acceptance.md`](91-slice-6-acceptance.md).  
